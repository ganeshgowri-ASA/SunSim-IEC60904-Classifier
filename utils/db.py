...
def init_database() -> bool:
    ...
    try:
        with engine.connect() as conn:
            ...
            # Simulator selections table for storing selected simulators (PR #10)
            if is_postgres:
                conn.execute(text("""
            ...
            # Reference module monitoring data table (PR #11)
            if is_postgres:
                conn.execute(text("""
...
# Simulator Selection Functions (PR #10)
...
# Reference Module Monitoring Functions (PR #11)
